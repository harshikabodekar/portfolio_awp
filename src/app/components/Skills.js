    ...
    <section id="skills" className="py-20 px-6 bg-gradient-to-b from-slate-800 to-slate-900 text-white">
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          ...
          {/* Optional: Add a proficiency section */}
          <div className="mt-16 border-2 border-white/20 rounded-xl p-10 backdrop-blur-sm bg-white/5">
            <h3 className="text-3xl md:text-4xl font-bold mb-8 text-center text-white">Proficiency Levels</h3>
              ...
              {[
                ...
                <div key={index}>
                  <div className="flex justify-between mb-2">
                    ...
                    <span className="text-lg font-bold text-blue-400">{item.level}%</span>
                  </div>
