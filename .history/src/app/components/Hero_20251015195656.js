      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20 relative z-10">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="flex flex-wrap gap-4 sm:gap-6 justify-center text-3xl sm:text-base px-4">
            <a href="https://github.com/harshikabodekar" target="_blank" rel="noopener noreferrer" className="text-white hover:text-blue-400 transition-colors text-">GitHub</a>
