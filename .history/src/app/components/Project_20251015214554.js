...
const Projects = () => {
  const projects = [
    ...
    {
      title: "Daycare Site ",
      description: "A user-friendly daycare website with features like online registration, event calendar, photo gallery, and parent-teacher communication portal.",
