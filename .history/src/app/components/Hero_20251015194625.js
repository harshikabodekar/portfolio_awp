      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20 relative z-10">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="inline-block mb-4 px-4 py-2 bg-blue-600 rounded-full">
            <p className="text-xs sm:text-sm font-medium text-white">Welcome to my portfolio</p>
          </div>
          
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold mb-4 sm:mb-6 bg-gradient-to-r from-white to-blue-400 bg-clip-text text-transparent px-4">
            Harshika Bodekar
          </h1>
          
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-300 mb-6 sm:mb-8 font-light px-4">
          ...
          <div className="flex flex-wrap gap-4 sm:gap-6 justify-center text-sm sm:text-base px-4">
            <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="text-white hover:text-blue-400 transition-colors">GitHub</a>
            <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="text-white hover:text-blue-400 transition-colors">LinkedIn</a>
            <a href="mailto:your.email@example.com" className="text-white hover:text-blue-400 transition-colors">Email</a>
          </div>
        </div>
      </div>
